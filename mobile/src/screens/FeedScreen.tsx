...
const styles = StyleSheet.create({
  ...
  storyViewerMedia: { ...StyleSheet.absoluteFill, height, width },
  ...
  storyTapLayer: { ...StyleSheet.absoluteFill, flexDirection: 'row', zIndex: 3 },
  storyTapZone: { flex: 1 },
  ...
  heartOverlay: { ...StyleSheet.absoluteFill, alignItems: 'center', justifyContent: 'center', zIndex: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 10 },
  ...
  storyOverlay: { ...StyleSheet.absoluteFill, backgroundColor: 'rgba(15,23,42,0.3)' },
  ...
  storyCardShade: { ...StyleSheet.absoluteFill, backgroundColor: 'rgba(15,23,42,0.22)', zIndex: 1 },
  ...
  storyVideoBadge: { ...StyleSheet.absoluteFill, alignItems: 'center', justifyContent: 'center', zIndex: 2 },
  ...
  storyVideoDraft: { ...StyleSheet.absoluteFill, alignItems: 'center', backgroundColor: '#101828', justifyContent: 'center' },
  storyVideoViewer: { ...StyleSheet.absoluteFill, alignItems: 'center', backgroundColor: '#101828', justifyContent: 'center' },
  ...
  videoPreviewShade: { ...StyleSheet.absoluteFill, alignItems: 'center', backgroundColor: 'rgba(15,23,42,0.26)', justifyContent: 'center' },
